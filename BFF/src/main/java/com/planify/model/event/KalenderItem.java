...
public class KalenderItem {
    ...
    public KalenderItem(String token, Event event, List<Teilnehmerliste> tnListe) {
        super();
        this.token = token;
        this.event = event;
    ...
    @JsonProperty("tnListe")
    public List<Teilnehmerliste> getTnListe() {
        return tnListe;
    }

    @JsonProperty("tnListe")
    public void setTnListe(List<Teilnehmerliste> tnListe) {
        this.tnListe = tnListe;
    }
